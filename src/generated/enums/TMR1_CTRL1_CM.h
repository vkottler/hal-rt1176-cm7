...
enum class TMR1_CTRL1_CM : uint8_t
{
    NOOP /*!< No operation */,
...
static_assert(sizeof(TMR1_CTRL1_CM) == 1);

/**
 * Converts TMR1_CTRL1_CM to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(TMR1_CTRL1_CM instance)
{
    const char *result = "UNKNOWN TMR1_CTRL1_CM";

    switch (instance)
    {
    case TMR1_CTRL1_CM::NOOP:
        result = "NOOP";
        break;
    case TMR1_CTRL1_CM::RISING_ONLY:
        result = "RISING_ONLY";
        break;
    case TMR1_CTRL1_CM::RISING_AND_FALLING:
        result = "RISING_AND_FALLING";
        break;
    case TMR1_CTRL1_CM::RISING_WHILE_SEC_HIGH:
        result = "RISING_WHILE_SEC_HIGH";
        break;
    case TMR1_CTRL1_CM::QUADRATURE:
        result = "QUADRATURE";
        break;
    case TMR1_CTRL1_CM::RISING_SEC_DIR:
        result = "RISING_SEC_DIR";
        break;
    case TMR1_CTRL1_CM::SECONDARY:
        result = "SECONDARY";
        break;
    case TMR1_CTRL1_CM::CASCADE:
        result = "CASCADE";
        break;
    }
...
/**
 * Converts a C string to TMR1_CTRL1_CM.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, TMR1_CTRL1_CM &output)
{
    bool result = false;

    if ((result = !strncmp(data, "NOOP", 4)))
    {
        output = TMR1_CTRL1_CM::NOOP;
    }
    else if ((result = !strncmp(data, "RISING_ONLY", 11)))
    {
        output = TMR1_CTRL1_CM::RISING_ONLY;
    }
    else if ((result = !strncmp(data, "RISING_AND_FALLING", 18)))
    {
        output = TMR1_CTRL1_CM::RISING_AND_FALLING;
    }
    else if ((result = !strncmp(data, "RISING_WHILE_SEC_HIGH", 21)))
    {
        output = TMR1_CTRL1_CM::RISING_WHILE_SEC_HIGH;
    }
    else if ((result = !strncmp(data, "QUADRATURE", 10)))
    {
        output = TMR1_CTRL1_CM::QUADRATURE;
    }
    else if ((result = !strncmp(data, "RISING_SEC_DIR", 14)))
    {
        output = TMR1_CTRL1_CM::RISING_SEC_DIR;
    }
    else if ((result = !strncmp(data, "SECONDARY", 9)))
    {
        output = TMR1_CTRL1_CM::SECONDARY;
    }
    else if ((result = !strncmp(data, "CASCADE", 7)))
    {
        output = TMR1_CTRL1_CM::CASCADE;
    }
