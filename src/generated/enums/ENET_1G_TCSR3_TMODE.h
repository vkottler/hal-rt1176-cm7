...
enum class ENET_1G_TCSR3_TMODE : uint8_t
{
...
static_assert(sizeof(ENET_1G_TCSR3_TMODE) == 1);

/**
 * Converts ENET_1G_TCSR3_TMODE to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(ENET_1G_TCSR3_TMODE instance)
{
    const char *result = "UNKNOWN ENET_1G_TCSR3_TMODE";

    switch (instance)
    {
    case ENET_1G_TCSR3_TMODE::DIS:
        result = "DIS";
        break;
    case ENET_1G_TCSR3_TMODE::RE:
        result = "RE";
        break;
    case ENET_1G_TCSR3_TMODE::FE:
        result = "FE";
        break;
    case ENET_1G_TCSR3_TMODE::BE:
        result = "BE";
        break;
    case ENET_1G_TCSR3_TMODE::OUT:
        result = "OUT";
        break;
    case ENET_1G_TCSR3_TMODE::TOGGLE:
        result = "TOGGLE";
        break;
    case ENET_1G_TCSR3_TMODE::CLR:
        result = "CLR";
        break;
    case ENET_1G_TCSR3_TMODE::SET_OUT:
        result = "SET_OUT";
        break;
    case ENET_1G_TCSR3_TMODE::CLR_SET1:
        result = "CLR_SET1";
        break;
    case ENET_1G_TCSR3_TMODE::CLR_SET:
        result = "CLR_SET";
        break;
    case ENET_1G_TCSR3_TMODE::OUT_CMP_LOW:
        result = "OUT_CMP_LOW";
        break;
    case ENET_1G_TCSR3_TMODE::OUT_CMP_HIGH:
        result = "OUT_CMP_HIGH";
        break;
    }
...
/**
 * Converts a C string to ENET_1G_TCSR3_TMODE.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, ENET_1G_TCSR3_TMODE &output)
{
    bool result = false;

    if ((result = !strncmp(data, "DIS", 3)))
    {
        output = ENET_1G_TCSR3_TMODE::DIS;
    }
    else if ((result = !strncmp(data, "RE", 2)))
    {
        output = ENET_1G_TCSR3_TMODE::RE;
    }
    else if ((result = !strncmp(data, "FE", 2)))
    {
        output = ENET_1G_TCSR3_TMODE::FE;
    }
    else if ((result = !strncmp(data, "BE", 2)))
    {
        output = ENET_1G_TCSR3_TMODE::BE;
    }
    else if ((result = !strncmp(data, "OUT", 3)))
    {
        output = ENET_1G_TCSR3_TMODE::OUT;
    }
    else if ((result = !strncmp(data, "TOGGLE", 6)))
    {
        output = ENET_1G_TCSR3_TMODE::TOGGLE;
    }
    else if ((result = !strncmp(data, "CLR", 3)))
    {
        output = ENET_1G_TCSR3_TMODE::CLR;
    }
    else if ((result = !strncmp(data, "SET_OUT", 7)))
    {
        output = ENET_1G_TCSR3_TMODE::SET_OUT;
    }
    else if ((result = !strncmp(data, "CLR_SET1", 8)))
    {
        output = ENET_1G_TCSR3_TMODE::CLR_SET1;
    }
    else if ((result = !strncmp(data, "CLR_SET", 7)))
    {
        output = ENET_1G_TCSR3_TMODE::CLR_SET;
    }
    else if ((result = !strncmp(data, "OUT_CMP_LOW", 11)))
    {
        output = ENET_1G_TCSR3_TMODE::OUT_CMP_LOW;
    }
    else if ((result = !strncmp(data, "OUT_CMP_HIGH", 12)))
    {
        output = ENET_1G_TCSR3_TMODE::OUT_CMP_HIGH;
    }
