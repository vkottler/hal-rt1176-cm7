...
enum class GPT1_CR_OM2 : uint8_t
{
...
static_assert(sizeof(GPT1_CR_OM2) == 1);

/**
 * Converts GPT1_CR_OM2 to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(GPT1_CR_OM2 instance)
{
    const char *result = "UNKNOWN GPT1_CR_OM2";

    switch (instance)
    {
    case GPT1_CR_OM2::DISABLED:
        result = "DISABLED";
        break;
    case GPT1_CR_OM2::TOGGLE:
        result = "TOGGLE";
        break;
    case GPT1_CR_OM2::CLEAR:
        result = "CLEAR";
        break;
    case GPT1_CR_OM2::SET:
        result = "SET";
        break;
    case GPT1_CR_OM2::PULSE:
        result = "PULSE";
        break;
    }
...
/**
 * Converts a C string to GPT1_CR_OM2.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, GPT1_CR_OM2 &output)
{
    bool result = false;

    if ((result = !strncmp(data, "DISABLED", 8)))
    {
        output = GPT1_CR_OM2::DISABLED;
    }
    else if ((result = !strncmp(data, "TOGGLE", 6)))
    {
        output = GPT1_CR_OM2::TOGGLE;
    }
    else if ((result = !strncmp(data, "CLEAR", 5)))
    {
        output = GPT1_CR_OM2::CLEAR;
    }
    else if ((result = !strncmp(data, "SET", 3)))
    {
        output = GPT1_CR_OM2::SET;
    }
    else if ((result = !strncmp(data, "PULSE", 5)))
    {
        output = GPT1_CR_OM2::PULSE;
    }
