...
enum class LPADC1_CMDH6_NEXT : uint8_t
{
...
static_assert(sizeof(LPADC1_CMDH6_NEXT) == 1);

/**
 * Converts LPADC1_CMDH6_NEXT to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(LPADC1_CMDH6_NEXT instance)
{
    const char *result = "UNKNOWN LPADC1_CMDH6_NEXT";

    switch (instance)
    {
    case LPADC1_CMDH6_NEXT::_0:
        result = "_0";
        break;
    case LPADC1_CMDH6_NEXT::_1:
        result = "_1";
        break;
    case LPADC1_CMDH6_NEXT::_2:
        result = "_2";
        break;
    case LPADC1_CMDH6_NEXT::_3:
        result = "_3";
        break;
    case LPADC1_CMDH6_NEXT::_4:
        result = "_4";
        break;
    case LPADC1_CMDH6_NEXT::_5:
        result = "_5";
        break;
    case LPADC1_CMDH6_NEXT::_6:
        result = "_6";
        break;
    case LPADC1_CMDH6_NEXT::_7:
        result = "_7";
        break;
    case LPADC1_CMDH6_NEXT::_8:
        result = "_8";
        break;
    case LPADC1_CMDH6_NEXT::_9:
        result = "_9";
        break;
    case LPADC1_CMDH6_NEXT::_15:
        result = "_15";
        break;
    }
...
/**
 * Converts a C string to LPADC1_CMDH6_NEXT.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, LPADC1_CMDH6_NEXT &output)
{
    bool result = false;

    if ((result = !strncmp(data, "_0", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_0;
    }
    else if ((result = !strncmp(data, "_1", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_1;
    }
    else if ((result = !strncmp(data, "_2", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_2;
    }
    else if ((result = !strncmp(data, "_3", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_3;
    }
    else if ((result = !strncmp(data, "_4", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_4;
    }
    else if ((result = !strncmp(data, "_5", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_5;
    }
    else if ((result = !strncmp(data, "_6", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_6;
    }
    else if ((result = !strncmp(data, "_7", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_7;
    }
    else if ((result = !strncmp(data, "_8", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_8;
    }
    else if ((result = !strncmp(data, "_9", 2)))
    {
        output = LPADC1_CMDH6_NEXT::_9;
    }
    else if ((result = !strncmp(data, "_15", 3)))
    {
        output = LPADC1_CMDH6_NEXT::_15;
    }
