...
#include "../enums/VIDEO_PLL_CTRL0_POST_DIV_SEL.h"
 ...
 * Fractional PLL
 */
struct [[gnu::packed]] video_pll
{
    /* Constant attributes. */
    static constexpr std::size_t size = 64; /*!< video_pll's size in bytes. */
     ...
     * Post Divide Select
     */
    inline VIDEO_PLL_CTRL0_POST_DIV_SEL get_CTRL0_POST_DIV_SEL() volatile
    {
        return VIDEO_PLL_CTRL0_POST_DIV_SEL((CTRL0 >> 25u) & 0b111u);
    }
    ...
    inline void set_CTRL0_POST_DIV_SEL(
        VIDEO_PLL_CTRL0_POST_DIV_SEL value) volatile
    {
        uint32_t curr = CTRL0;
    ...
    inline void get_CTRL0(bool &BIAS_SELECT,
                          VIDEO_PLL_CTRL0_POST_DIV_SEL &POST_DIV_SEL,
                          ...
                          uint8_t &DIV_SELECT) volatile
    {
        ...
        POST_DIV_SEL = VIDEO_PLL_CTRL0_POST_DIV_SEL((curr >> 25u) & 0b111u);
...
static_assert(sizeof(video_pll) == video_pll::size);

static volatile video_pll *const VIDEO_PLL = reinterpret_cast<video_pll *>(0);
