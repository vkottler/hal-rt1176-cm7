...
#include "../enums/AUDIO_PLL_CTRL0_POST_DIV_SEL.h"
 ...
 * Fractional PLL
 */
struct [[gnu::packed]] audio_pll
{
    /* Constant attributes. */
    static constexpr std::size_t size = 64; /*!< audio_pll's size in bytes. */
     ...
     * Post Divide Select
     */
    inline AUDIO_PLL_CTRL0_POST_DIV_SEL get_CTRL0_POST_DIV_SEL() volatile
    {
        return AUDIO_PLL_CTRL0_POST_DIV_SEL((CTRL0 >> 25u) & 0b111u);
    }
    ...
    inline void set_CTRL0_POST_DIV_SEL(
        AUDIO_PLL_CTRL0_POST_DIV_SEL value) volatile
    {
        uint32_t curr = CTRL0;
    ...
    inline void get_CTRL0(bool &BIAS_SELECT,
                          AUDIO_PLL_CTRL0_POST_DIV_SEL &POST_DIV_SEL,
                          ...
                          uint8_t &DIV_SELECT) volatile
    {
        ...
        POST_DIV_SEL = AUDIO_PLL_CTRL0_POST_DIV_SEL((curr >> 25u) & 0b111u);
...
static_assert(sizeof(audio_pll) == audio_pll::size);

static volatile audio_pll *const AUDIO_PLL = reinterpret_cast<audio_pll *>(0);
