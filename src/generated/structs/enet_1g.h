...
#include "../enums/ENET_1G_MSCR_HOLDTIME.h"
#include "../enums/ENET_1G_QOS_TX_SCHEME.h"
#include "../enums/ENET_1G_TCR_ADDSEL.h"
#include "../enums/ENET_1G_TCSR0_TMODE.h"
#include "../enums/ENET_1G_TCSR1_TMODE.h"
#include "../enums/ENET_1G_TCSR2_TMODE.h"
#include "../enums/ENET_1G_TCSR3_TMODE.h"
#include "../enums/ENET_1G_TFWR_TFWR.h"
 ...
 * ENET
 */
struct [[gnu::packed]] enet_1g
{
    /* Constant attributes. */
    static constexpr std::size_t size = 1576; /*!< enet_1g's size in bytes. */
    ...
    static constexpr std::size_t reserved_padding11_length = 6;
    const uint32_t reserved_padding11[reserved_padding11_length] = {};
    uint32_t
        RDSR1; /*!< (read-write) Receive Descriptor Ring 1 Start Register */
    uint32_t TDSR1; /*!< (read-write) Transmit Buffer Descriptor Ring 1 Start
                       Register */
    uint32_t MRBR1; /*!< (read-write) Maximum Receive Buffer Size Register -
                       Ring 1 */
    uint32_t
        RDSR2; /*!< (read-write) Receive Descriptor Ring 2 Start Register */
    uint32_t TDSR2; /*!< (read-write) Transmit Buffer Descriptor Ring 2 Start
                       Register */
    uint32_t MRBR2; /*!< (read-write) Maximum Receive Buffer Size Register -
                       Ring 2 */
    ...
    static constexpr std::size_t RCMR_length = 2;
    uint32_t RCMR[RCMR_length]; /*!< (read-write) Receive Classification Match
                                   Register for Class n */
    static constexpr std::size_t reserved_padding15_length = 2;
    const uint32_t reserved_padding15[reserved_padding15_length] = {};
    static constexpr std::size_t DMACFG_length = 2;
    uint32_t DMACFG[DMACFG_length]; /*!< (read-write) DMA Class Based
                                       Configuration */
    uint32_t
        RDAR1; /*!< (read-write) Receive Descriptor Active Register - Ring 1 */
    uint32_t TDAR1; /*!< (read-write) Transmit Descriptor Active Register -
                       Ring 1 */
    uint32_t
        RDAR2; /*!< (read-write) Receive Descriptor Active Register - Ring 2 */
    uint32_t TDAR2; /*!< (read-write) Transmit Descriptor Active Register -
                       Ring 2 */
    uint32_t QOS;   /*!< (read-write) QOS Scheme */
    static constexpr std::size_t reserved_padding16_length = 4;
    ...
    static constexpr std::size_t reserved_padding19_length = 71;
    ...
    static constexpr std::size_t reserved_padding20_length = 122;
    ...
    /**
     * Get EIR's RXFLUSH_2 bit.
     *
     * RX DMA Ring 2 flush indication
     */
    inline bool get_EIR_RXFLUSH_2() volatile
    {
        return EIR & (1u << 14u);
    }

    /**
     * Set EIR's RXFLUSH_2 bit.
     *
     * RX DMA Ring 2 flush indication
     */
    inline void set_EIR_RXFLUSH_2() volatile
    {
        EIR |= 1u << 14u;
    }

    /**
     * Clear EIR's RXFLUSH_2 bit.
     *
     * RX DMA Ring 2 flush indication
     */
    inline void clear_EIR_RXFLUSH_2() volatile
    {
        EIR &= ~(1u << 14u);
    }

    /**
     * Toggle EIR's RXFLUSH_2 bit.
     *
     * RX DMA Ring 2 flush indication
     */
    inline void toggle_EIR_RXFLUSH_2() volatile
    {
        EIR ^= 1u << 14u;
    }

    /**
     * Get EIR's RXFLUSH_1 bit.
     *
     * RX DMA Ring 1 flush indication
     */
    inline bool get_EIR_RXFLUSH_1() volatile
    {
        return EIR & (1u << 13u);
    }

    /**
     * Set EIR's RXFLUSH_1 bit.
     *
     * RX DMA Ring 1 flush indication
     */
    inline void set_EIR_RXFLUSH_1() volatile
    {
        EIR |= 1u << 13u;
    }

    /**
     * Clear EIR's RXFLUSH_1 bit.
     *
     * RX DMA Ring 1 flush indication
     */
    inline void clear_EIR_RXFLUSH_1() volatile
    {
        EIR &= ~(1u << 13u);
    }

    /**
     * Toggle EIR's RXFLUSH_1 bit.
     *
     * RX DMA Ring 1 flush indication
     */
    inline void toggle_EIR_RXFLUSH_1() volatile
    {
        EIR ^= 1u << 13u;
    }

    /**
     * Get EIR's RXFLUSH_0 bit.
     *
     * RX DMA Ring 0 flush indication
     */
    inline bool get_EIR_RXFLUSH_0() volatile
    {
        return EIR & (1u << 12u);
    }

    /**
     * Set EIR's RXFLUSH_0 bit.
     *
     * RX DMA Ring 0 flush indication
     */
    inline void set_EIR_RXFLUSH_0() volatile
    {
        EIR |= 1u << 12u;
    }

    /**
     * Clear EIR's RXFLUSH_0 bit.
     *
     * RX DMA Ring 0 flush indication
     */
    inline void clear_EIR_RXFLUSH_0() volatile
    {
        EIR &= ~(1u << 12u);
    }

    /**
     * Toggle EIR's RXFLUSH_0 bit.
     *
     * RX DMA Ring 0 flush indication
     */
    inline void toggle_EIR_RXFLUSH_0() volatile
    {
        EIR ^= 1u << 12u;
    }
     ...
     */
    inline bool get_EIR_TXF2() volatile
    {
        return EIR & (1u << 7u);
    }
     ...
     * Transmit frame interrupt, class 2
     */
    inline void set_EIR_TXF2() volatile
    {
        EIR |= 1u << 7u;
    }

    /**
     * Clear EIR's TXF2 bit.
     *
     * Transmit frame interrupt, class 2
     */
    inline void clear_EIR_TXF2() volatile
    {
        EIR &= ~(1u << 7u);
    }

    /**
     * Toggle EIR's TXF2 bit.
     *
     * Transmit frame interrupt, class 2
     */
    inline void toggle_EIR_TXF2() volatile
    {
        EIR ^= 1u << 7u;
    }
     ...
     */
    inline bool get_EIR_TXB2() volatile
    {
        return EIR & (1u << 6u);
    }
     ...
     * Transmit buffer interrupt, class 2
     */
    inline void set_EIR_TXB2() volatile
    {
        EIR |= 1u << 6u;
    }

    /**
     * Clear EIR's TXB2 bit.
     *
     * Transmit buffer interrupt, class 2
     */
    inline void clear_EIR_TXB2() volatile
    {
        EIR &= ~(1u << 6u);
    }

    /**
     * Toggle EIR's TXB2 bit.
     *
     * Transmit buffer interrupt, class 2
     */
    inline void toggle_EIR_TXB2() volatile
    {
        EIR ^= 1u << 6u;
    }
     ...
     */
    inline bool get_EIR_RXF2() volatile
    {
        return EIR & (1u << 5u);
    }
     ...
     * Receive frame interrupt, class 2
     */
    inline void set_EIR_RXF2() volatile
    {
        EIR |= 1u << 5u;
    }

    /**
     * Clear EIR's RXF2 bit.
     *
     * Receive frame interrupt, class 2
     */
    inline void clear_EIR_RXF2() volatile
    {
        EIR &= ~(1u << 5u);
    }

    /**
     * Toggle EIR's RXF2 bit.
     *
     * Receive frame interrupt, class 2
     */
    inline void toggle_EIR_RXF2() volatile
    {
        EIR ^= 1u << 5u;
    }
     ...
     */
    inline bool get_EIR_RXB2() volatile
    {
        return EIR & (1u << 4u);
    }
     ...
     * Receive buffer interrupt, class 2
     */
    inline void set_EIR_RXB2() volatile
    {
        EIR |= 1u << 4u;
    }

    /**
     * Clear EIR's RXB2 bit.
     *
     * Receive buffer interrupt, class 2
     */
    inline void clear_EIR_RXB2() volatile
    {
        EIR &= ~(1u << 4u);
    }

    /**
     * Toggle EIR's RXB2 bit.
     *
     * Receive buffer interrupt, class 2
     */
    inline void toggle_EIR_RXB2() volatile
    {
        EIR ^= 1u << 4u;
    }
     ...
     */
    inline bool get_EIR_TXF1() volatile
    {
        return EIR & (1u << 3u);
    }
     ...
     * Transmit frame interrupt, class 1
     */
    inline void set_EIR_TXF1() volatile
    {
        EIR |= 1u << 3u;
    }

    /**
     * Clear EIR's TXF1 bit.
     *
     * Transmit frame interrupt, class 1
     */
    inline void clear_EIR_TXF1() volatile
    {
        EIR &= ~(1u << 3u);
    }

    /**
     * Toggle EIR's TXF1 bit.
     *
     * Transmit frame interrupt, class 1
     */
    inline void toggle_EIR_TXF1() volatile
    {
        EIR ^= 1u << 3u;
    }
     ...
     */
    inline bool get_EIR_TXB1() volatile
    {
        return EIR & (1u << 2u);
    }
     ...
     * Transmit buffer interrupt, class 1
     */
    inline void set_EIR_TXB1() volatile
    {
        EIR |= 1u << 2u;
    }

    /**
     * Clear EIR's TXB1 bit.
     *
     * Transmit buffer interrupt, class 1
     */
    inline void clear_EIR_TXB1() volatile
    {
        EIR &= ~(1u << 2u);
    }

    /**
     * Toggle EIR's TXB1 bit.
     *
     * Transmit buffer interrupt, class 1
     */
    inline void toggle_EIR_TXB1() volatile
    {
        EIR ^= 1u << 2u;
    }
     ...
     */
    inline bool get_EIR_RXF1() volatile
    {
        return EIR & (1u << 1u);
    }
     ...
     * Receive frame interrupt, class 1
     */
    inline void set_EIR_RXF1() volatile
    {
        EIR |= 1u << 1u;
    }

    /**
     * Clear EIR's RXF1 bit.
     *
     * Receive frame interrupt, class 1
     */
    inline void clear_EIR_RXF1() volatile
    {
        EIR &= ~(1u << 1u);
    }

    /**
     * Toggle EIR's RXF1 bit.
     *
     * Receive frame interrupt, class 1
     */
    inline void toggle_EIR_RXF1() volatile
    {
        EIR ^= 1u << 1u;
    }
     ...
     */
    inline bool get_EIR_RXB1() volatile
    {
        return EIR & (1u << 0u);
    }
     ...
     * Receive buffer interrupt, class 1
     */
    inline void set_EIR_RXB1() volatile
    {
        EIR |= 1u << 0u;
    }

    /**
     * Clear EIR's RXB1 bit.
     *
     * Receive buffer interrupt, class 1
     */
    inline void clear_EIR_RXB1() volatile
    {
        EIR &= ~(1u << 0u);
    }

    /**
     * Toggle EIR's RXB1 bit.
     *
     * Receive buffer interrupt, class 1
     */
    inline void toggle_EIR_RXB1() volatile
    {
        EIR ^= 1u << 0u;
    }
    ...
    inline void get_EIR(bool &BABR, bool &BABT, bool &GRA, bool &TXF,
                        ...
                        bool &WAKEUP, bool &TS_AVAIL, bool &TS_TIMER,
                        bool &RXFLUSH_2, bool &RXFLUSH_1, bool &RXFLUSH_0,
                        bool &TXF2, bool &TXB2, bool &RXF2, bool &RXB2,
                        bool &TXF1, bool &TXB1, bool &RXF1,
                        bool &RXB1) volatile
    {
        uint32_t curr = EIR;
        ...
        RXFLUSH_2 = curr & (1u << 14u);
        RXFLUSH_1 = curr & (1u << 13u);
        RXFLUSH_0 = curr & (1u << 12u);
        TXF2 = curr & (1u << 7u);
        TXB2 = curr & (1u << 6u);
        RXF2 = curr & (1u << 5u);
        RXB2 = curr & (1u << 4u);
    ...
    inline void set_EIR(bool BABR, bool BABT, bool GRA, bool TXF, bool TXB,
                        ...
                        bool TS_TIMER, bool RXFLUSH_2, bool RXFLUSH_1,
                        bool RXFLUSH_0, bool TXF2, bool TXB2, bool RXF2,
                        bool RXB2, bool TXF1, bool TXB1, bool RXF1,
                        bool RXB1) volatile
    {
        uint32_t curr = EIR;
        ...
        curr &= ~(0b1u << 14u);
        curr |= (RXFLUSH_2 & 0b1u) << 14u;
        curr &= ~(0b1u << 13u);
        curr |= (RXFLUSH_1 & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (RXFLUSH_0 & 0b1u) << 12u;
        curr &= ~(0b1u << 7u);
        curr |= (TXF2 & 0b1u) << 7u;
        curr &= ~(0b1u << 6u);
        curr |= (TXB2 & 0b1u) << 6u;
    ...
    /**
     * Get EIMR's RXFLUSH_2 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_2] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline bool get_EIMR_RXFLUSH_2() volatile
    {
        return EIMR & (1u << 14u);
    }

    /**
     * Set EIMR's RXFLUSH_2 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_2] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void set_EIMR_RXFLUSH_2() volatile
    {
        EIMR |= 1u << 14u;
    }

    /**
     * Clear EIMR's RXFLUSH_2 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_2] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void clear_EIMR_RXFLUSH_2() volatile
    {
        EIMR &= ~(1u << 14u);
    }

    /**
     * Toggle EIMR's RXFLUSH_2 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_2] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void toggle_EIMR_RXFLUSH_2() volatile
    {
        EIMR ^= 1u << 14u;
    }

    /**
     * Get EIMR's RXFLUSH_1 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_1] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline bool get_EIMR_RXFLUSH_1() volatile
    {
        return EIMR & (1u << 13u);
    }

    /**
     * Set EIMR's RXFLUSH_1 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_1] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void set_EIMR_RXFLUSH_1() volatile
    {
        EIMR |= 1u << 13u;
    }

    /**
     * Clear EIMR's RXFLUSH_1 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_1] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void clear_EIMR_RXFLUSH_1() volatile
    {
        EIMR &= ~(1u << 13u);
    }

    /**
     * Toggle EIMR's RXFLUSH_1 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_1] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void toggle_EIMR_RXFLUSH_1() volatile
    {
        EIMR ^= 1u << 13u;
    }

    /**
     * Get EIMR's RXFLUSH_0 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_0] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline bool get_EIMR_RXFLUSH_0() volatile
    {
        return EIMR & (1u << 12u);
    }

    /**
     * Set EIMR's RXFLUSH_0 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_0] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void set_EIMR_RXFLUSH_0() volatile
    {
        EIMR |= 1u << 12u;
    }

    /**
     * Clear EIMR's RXFLUSH_0 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_0] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void clear_EIMR_RXFLUSH_0() volatile
    {
        EIMR &= ~(1u << 12u);
    }

    /**
     * Toggle EIMR's RXFLUSH_0 bit.
     *
     * Corresponds to interrupt source EIR[RXFLUSH_0] and determines whether an
     * interrupt condition can generate an interrupt
     */
    inline void toggle_EIMR_RXFLUSH_0() volatile
    {
        EIMR ^= 1u << 12u;
    }
     ...
     * Transmit frame interrupt, class 2
     */
    inline bool get_EIMR_TXF2() volatile
    {
        return EIMR & (1u << 7u);
    }
     ...
     * Transmit frame interrupt, class 2
     */
    inline void set_EIMR_TXF2() volatile
    {
        EIMR |= 1u << 7u;
    }

    /**
     * Clear EIMR's TXF2 bit.
     *
     * Transmit frame interrupt, class 2
     */
    inline void clear_EIMR_TXF2() volatile
    {
        EIMR &= ~(1u << 7u);
    }

    /**
     * Toggle EIMR's TXF2 bit.
     *
     * Transmit frame interrupt, class 2
     */
    inline void toggle_EIMR_TXF2() volatile
    {
        EIMR ^= 1u << 7u;
    }
     ...
     * Transmit buffer interrupt, class 2
     */
    inline bool get_EIMR_TXB2() volatile
    {
        return EIMR & (1u << 6u);
    }
     ...
     * Transmit buffer interrupt, class 2
     */
    inline void set_EIMR_TXB2() volatile
    {
        EIMR |= 1u << 6u;
    }

    /**
     * Clear EIMR's TXB2 bit.
     *
     * Transmit buffer interrupt, class 2
     */
    inline void clear_EIMR_TXB2() volatile
    {
        EIMR &= ~(1u << 6u);
    }

    /**
     * Toggle EIMR's TXB2 bit.
     *
     * Transmit buffer interrupt, class 2
     */
    inline void toggle_EIMR_TXB2() volatile
    {
        EIMR ^= 1u << 6u;
    }
     ...
     * Receive frame interrupt, class 2
     */
    inline bool get_EIMR_RXF2() volatile
    {
        return EIMR & (1u << 5u);
    }
     ...
     * Receive frame interrupt, class 2
     */
    inline void set_EIMR_RXF2() volatile
    {
        EIMR |= 1u << 5u;
    }

    /**
     * Clear EIMR's RXF2 bit.
     *
     * Receive frame interrupt, class 2
     */
    inline void clear_EIMR_RXF2() volatile
    {
        EIMR &= ~(1u << 5u);
    }

    /**
     * Toggle EIMR's RXF2 bit.
     *
     * Receive frame interrupt, class 2
     */
    inline void toggle_EIMR_RXF2() volatile
    {
        EIMR ^= 1u << 5u;
    }
     ...
     * Receive buffer interrupt, class 2
     */
    inline bool get_EIMR_RXB2() volatile
    {
        return EIMR & (1u << 4u);
    }
     ...
     * Receive buffer interrupt, class 2
     */
    inline void set_EIMR_RXB2() volatile
    {
        EIMR |= 1u << 4u;
    }

    /**
     * Clear EIMR's RXB2 bit.
     *
     * Receive buffer interrupt, class 2
     */
    inline void clear_EIMR_RXB2() volatile
    {
        EIMR &= ~(1u << 4u);
    }

    /**
     * Toggle EIMR's RXB2 bit.
     *
     * Receive buffer interrupt, class 2
     */
    inline void toggle_EIMR_RXB2() volatile
    {
        EIMR ^= 1u << 4u;
    }
     ...
     * Transmit frame interrupt, class 1
     */
    inline bool get_EIMR_TXF1() volatile
    {
        return EIMR & (1u << 3u);
    }
     ...
     * Transmit frame interrupt, class 1
     */
    inline void set_EIMR_TXF1() volatile
    {
        EIMR |= 1u << 3u;
    }

    /**
     * Clear EIMR's TXF1 bit.
     *
     * Transmit frame interrupt, class 1
     */
    inline void clear_EIMR_TXF1() volatile
    {
        EIMR &= ~(1u << 3u);
    }

    /**
     * Toggle EIMR's TXF1 bit.
     *
     * Transmit frame interrupt, class 1
     */
    inline void toggle_EIMR_TXF1() volatile
    {
        EIMR ^= 1u << 3u;
    }
     ...
     * Transmit buffer interrupt, class 1
     */
    inline bool get_EIMR_TXB1() volatile
    {
        return EIMR & (1u << 2u);
    }
     ...
     * Transmit buffer interrupt, class 1
     */
    inline void set_EIMR_TXB1() volatile
    {
        EIMR |= 1u << 2u;
    }

    /**
     * Clear EIMR's TXB1 bit.
     *
     * Transmit buffer interrupt, class 1
     */
    inline void clear_EIMR_TXB1() volatile
    {
        EIMR &= ~(1u << 2u);
    }

    /**
     * Toggle EIMR's TXB1 bit.
     *
     * Transmit buffer interrupt, class 1
     */
    inline void toggle_EIMR_TXB1() volatile
    {
        EIMR ^= 1u << 2u;
    }
     ...
     * Receive frame interrupt, class 1
     */
    inline bool get_EIMR_RXF1() volatile
    {
        return EIMR & (1u << 1u);
    }
     ...
     * Receive frame interrupt, class 1
     */
    inline void set_EIMR_RXF1() volatile
    {
        EIMR |= 1u << 1u;
    }

    /**
     * Clear EIMR's RXF1 bit.
     *
     * Receive frame interrupt, class 1
     */
    inline void clear_EIMR_RXF1() volatile
    {
        EIMR &= ~(1u << 1u);
    }

    /**
     * Toggle EIMR's RXF1 bit.
     *
     * Receive frame interrupt, class 1
     */
    inline void toggle_EIMR_RXF1() volatile
    {
        EIMR ^= 1u << 1u;
    }
     ...
     * Receive buffer interrupt, class 1
     */
    inline bool get_EIMR_RXB1() volatile
    {
        return EIMR & (1u << 0u);
    }
     ...
     * Receive buffer interrupt, class 1
     */
    inline void set_EIMR_RXB1() volatile
    {
        EIMR |= 1u << 0u;
    }

    /**
     * Clear EIMR's RXB1 bit.
     *
     * Receive buffer interrupt, class 1
     */
    inline void clear_EIMR_RXB1() volatile
    {
        EIMR &= ~(1u << 0u);
    }

    /**
     * Toggle EIMR's RXB1 bit.
     *
     * Receive buffer interrupt, class 1
     */
    inline void toggle_EIMR_RXB1() volatile
    {
        EIMR ^= 1u << 0u;
    }
    ...
    inline void set_EIMR(bool BABR, bool BABT, bool GRA, bool TXF, bool TXB,
                         ...
                         bool TS_AVAIL, bool TS_TIMER, bool RXFLUSH_2,
                         bool RXFLUSH_1, bool RXFLUSH_0, bool TXF2, bool TXB2,
                         bool RXF2, bool RXB2, bool TXF1, bool TXB1, bool RXF1,
                         bool RXB1) volatile
    {
        uint32_t curr = EIMR;
    ...
    /**
     * Get ECR's TXC_DLY bit.
     *
     * Transmit clock delay
     */
    inline bool get_ECR_TXC_DLY() volatile
    {
        return ECR & (1u << 16u);
    }

    /**
     * Set ECR's TXC_DLY bit.
     *
     * Transmit clock delay
     */
    inline void set_ECR_TXC_DLY() volatile
    {
        ECR |= 1u << 16u;
    }

    /**
     * Clear ECR's TXC_DLY bit.
     *
     * Transmit clock delay
     */
    inline void clear_ECR_TXC_DLY() volatile
    {
        ECR &= ~(1u << 16u);
    }

    /**
     * Toggle ECR's TXC_DLY bit.
     *
     * Transmit clock delay
     */
    inline void toggle_ECR_TXC_DLY() volatile
    {
        ECR ^= 1u << 16u;
    }

    /**
     * Get ECR's SVLANDBL bit.
     *
     * S-VLAN double tag
     */
    inline bool get_ECR_SVLANDBL() volatile
    {
        return ECR & (1u << 11u);
    }

    /**
     * Set ECR's SVLANDBL bit.
     *
     * S-VLAN double tag
     */
    inline void set_ECR_SVLANDBL() volatile
    {
        ECR |= 1u << 11u;
    }

    /**
     * Clear ECR's SVLANDBL bit.
     *
     * S-VLAN double tag
     */
    inline void clear_ECR_SVLANDBL() volatile
    {
        ECR &= ~(1u << 11u);
    }

    /**
     * Toggle ECR's SVLANDBL bit.
     *
     * S-VLAN double tag
     */
    inline void toggle_ECR_SVLANDBL() volatile
    {
        ECR ^= 1u << 11u;
    }

    /**
     * Get ECR's VLANUSE2ND bit.
     *
     * VLAN use second tag
     */
    inline bool get_ECR_VLANUSE2ND() volatile
    {
        return ECR & (1u << 10u);
    }

    /**
     * Set ECR's VLANUSE2ND bit.
     *
     * VLAN use second tag
     */
    inline void set_ECR_VLANUSE2ND() volatile
    {
        ECR |= 1u << 10u;
    }

    /**
     * Clear ECR's VLANUSE2ND bit.
     *
     * VLAN use second tag
     */
    inline void clear_ECR_VLANUSE2ND() volatile
    {
        ECR &= ~(1u << 10u);
    }

    /**
     * Toggle ECR's VLANUSE2ND bit.
     *
     * VLAN use second tag
     */
    inline void toggle_ECR_VLANUSE2ND() volatile
    {
        ECR ^= 1u << 10u;
    }

    /**
     * Get ECR's SVLANEN bit.
     *
     * S-VLAN enable
     */
    inline bool get_ECR_SVLANEN() volatile
    {
        return ECR & (1u << 9u);
    }

    /**
     * Set ECR's SVLANEN bit.
     *
     * S-VLAN enable
     */
    inline void set_ECR_SVLANEN() volatile
    {
        ECR |= 1u << 9u;
    }

    /**
     * Clear ECR's SVLANEN bit.
     *
     * S-VLAN enable
     */
    inline void clear_ECR_SVLANEN() volatile
    {
        ECR &= ~(1u << 9u);
    }

    /**
     * Toggle ECR's SVLANEN bit.
     *
     * S-VLAN enable
     */
    inline void toggle_ECR_SVLANEN() volatile
    {
        ECR ^= 1u << 9u;
    }
     ...
     */
    inline bool get_ECR_SPEED() volatile
    {
        return ECR & (1u << 5u);
    }
     ...
     * Selects between 10/100-Mbit/s and 1000-Mbit/s modes of operation.
     */
    inline void set_ECR_SPEED() volatile
    {
        ECR |= 1u << 5u;
    }

    /**
     * Clear ECR's SPEED bit.
     *
     * Selects between 10/100-Mbit/s and 1000-Mbit/s modes of operation.
     */
    inline void clear_ECR_SPEED() volatile
    {
        ECR &= ~(1u << 5u);
    }

    /**
     * Toggle ECR's SPEED bit.
     *
     * Selects between 10/100-Mbit/s and 1000-Mbit/s modes of operation.
     */
    inline void toggle_ECR_SPEED() volatile
    {
        ECR ^= 1u << 5u;
    }
     ...
     */
    inline void get_ECR(bool &TXC_DLY, bool &SVLANDBL, bool &VLANUSE2ND,
                        bool &SVLANEN, bool &DBSWP, bool &DBGEN, bool &SPEED,
                        bool &EN1588, bool &SLEEP, bool &MAGICEN,
                        bool &ETHEREN, bool &RESET) volatile
    {
        uint32_t curr = ECR;

        TXC_DLY = curr & (1u << 16u);
        SVLANDBL = curr & (1u << 11u);
        VLANUSE2ND = curr & (1u << 10u);
        SVLANEN = curr & (1u << 9u);
        DBSWP = curr & (1u << 8u);
        DBGEN = curr & (1u << 6u);
        SPEED = curr & (1u << 5u);
     ...
     * (read-write) Ethernet Control Register
     */
    inline void set_ECR(bool TXC_DLY, bool SVLANDBL, bool VLANUSE2ND,
                        bool SVLANEN, bool DBSWP, bool DBGEN, bool SPEED,
                        bool EN1588, bool SLEEP, bool MAGICEN, bool ETHEREN,
                        bool RESET) volatile
    {
        uint32_t curr = ECR;

        curr &= ~(0b1u << 16u);
        curr |= (TXC_DLY & 0b1u) << 16u;
        curr &= ~(0b1u << 11u);
        curr |= (SVLANDBL & 0b1u) << 11u;
        curr &= ~(0b1u << 10u);
        curr |= (VLANUSE2ND & 0b1u) << 10u;
        curr &= ~(0b1u << 9u);
        curr |= (SVLANEN & 0b1u) << 9u;
        curr &= ~(0b1u << 8u);
        curr |= (DBSWP & 0b1u) << 8u;
        curr &= ~(0b1u << 6u);
        curr |= (DBGEN & 0b1u) << 6u;
     ...
     */
    inline ENET_1G_MSCR_HOLDTIME get_MSCR_HOLDTIME() volatile
    {
        return ENET_1G_MSCR_HOLDTIME((MSCR >> 8u) & 0b111u);
    }
     ...
     * Hold time On MDIO Output
     */
    inline void set_MSCR_HOLDTIME(ENET_1G_MSCR_HOLDTIME value) volatile
    {
        uint32_t curr = MSCR;
     ...
     */
    inline void get_MSCR(ENET_1G_MSCR_HOLDTIME &HOLDTIME, bool &DIS_PRE,
                         uint8_t &MII_SPEED) volatile
    {
        uint32_t curr = MSCR;

        HOLDTIME = ENET_1G_MSCR_HOLDTIME((curr >> 8u) & 0b111u);
        DIS_PRE = curr & (1u << 7u);
     ...
     * (read-write) MII Speed Control Register
     */
    inline void set_MSCR(ENET_1G_MSCR_HOLDTIME HOLDTIME, bool DIS_PRE,
                         uint8_t MII_SPEED) volatile
    {
        uint32_t curr = MSCR;
    ...
    /**
     * Get RCR's RGMII_EN bit.
     *
     * RGMII Mode Enable
     */
    inline bool get_RCR_RGMII_EN() volatile
    {
        return RCR & (1u << 6u);
    }

    /**
     * Set RCR's RGMII_EN bit.
     *
     * RGMII Mode Enable
     */
    inline void set_RCR_RGMII_EN() volatile
    {
        RCR |= 1u << 6u;
    }

    /**
     * Clear RCR's RGMII_EN bit.
     *
     * RGMII Mode Enable
     */
    inline void clear_RCR_RGMII_EN() volatile
    {
        RCR &= ~(1u << 6u);
    }

    /**
     * Toggle RCR's RGMII_EN bit.
     *
     * RGMII Mode Enable
     */
    inline void toggle_RCR_RGMII_EN() volatile
    {
        RCR ^= 1u << 6u;
    }
    ...
    inline void get_RCR(bool &GRS, bool &NLC, uint16_t &MAX_FL, bool &CFEN,
                        ...
                        bool &RMII_10T, bool &RMII_MODE, bool &RGMII_EN,
    ...
    inline void set_RCR(bool NLC, uint16_t MAX_FL, bool CFEN, bool CRCFWD,
                        ...
                        bool RGMII_EN, bool FCE, bool BC_REJ, bool PROM,
                        bool MII_MODE, bool DRT, bool LOOP) volatile
    {
        uint32_t curr = RCR;
     ...
     */
    inline ENET_1G_TCR_ADDSEL get_TCR_ADDSEL() volatile
    {
        return ENET_1G_TCR_ADDSEL((TCR >> 5u) & 0b111u);
    }
     ...
     * Source MAC Address Select On Transmit
     */
    inline void set_TCR_ADDSEL(ENET_1G_TCR_ADDSEL value) volatile
    {
        uint32_t curr = TCR;
     ...
     */
    inline void get_TCR(bool &CRCFWD, bool &ADDINS, ENET_1G_TCR_ADDSEL &ADDSEL,
                        ...
                        bool &GTS) volatile
    {
        ...
        CRCFWD = curr & (1u << 9u);
        ADDINS = curr & (1u << 8u);
        ADDSEL = ENET_1G_TCR_ADDSEL((curr >> 5u) & 0b111u);
     ...
     * (read-write) Transmit Control Register
     */
    inline void set_TCR(bool CRCFWD, bool ADDINS, ENET_1G_TCR_ADDSEL ADDSEL,
     ...
     * Transmit FIFO Write
     */
    inline ENET_1G_TFWR_TFWR get_TFWR_TFWR() volatile
    {
        return ENET_1G_TFWR_TFWR((TFWR >> 0u) & 0b111111u);
    }
     ...
     * Transmit FIFO Write
     */
    inline void set_TFWR_TFWR(ENET_1G_TFWR_TFWR value) volatile
    {
        uint32_t curr = TFWR;
     ...
     */
    inline void get_TFWR(bool &STRFWD, ENET_1G_TFWR_TFWR &TFWR) volatile
    {
        uint32_t curr = TFWR;

        STRFWD = curr & (1u << 8u);
        TFWR = ENET_1G_TFWR_TFWR((curr >> 0u) & 0b111111u);
    }
     ...
     * (read-write) Transmit FIFO Watermark Register
     */
    inline void set_TFWR(bool STRFWD, ENET_1G_TFWR_TFWR TFWR) volatile
    {
        uint32_t curr = TFWR;
    ...
    /**
     * Get RDSR1's R_DES_START field.
     *
     * Pointer to the beginning of the receive buffer descriptor queue 1.
     */
    inline uint32_t get_RDSR1_R_DES_START() volatile
    {
        return (RDSR1 >> 3u) & 0b11111111111111111111111111111u;
    }

    /**
     * Set RDSR1's R_DES_START field.
     *
     * Pointer to the beginning of the receive buffer descriptor queue 1.
     */
    inline void set_RDSR1_R_DES_START(uint32_t value) volatile
    {
        uint32_t curr = RDSR1;
    ...
    /**
     * Get TDSR1's X_DES_START field.
     *
     * Pointer to the beginning of transmit buffer descriptor queue 1.
     */
    inline uint32_t get_TDSR1_X_DES_START() volatile
    {
        return (TDSR1 >> 3u) & 0b11111111111111111111111111111u;
    }

    /**
     * Set TDSR1's X_DES_START field.
     *
     * Pointer to the beginning of transmit buffer descriptor queue 1.
     */
    inline void set_TDSR1_X_DES_START(uint32_t value) volatile
    {
        uint32_t curr = TDSR1;
    ...
    /**
     * Get MRBR1's R_BUF_SIZE field.
     *
     * Receive buffer size (in bytes)
     */
    inline uint8_t get_MRBR1_R_BUF_SIZE() volatile
    {
        return (MRBR1 >> 4u) & 0b1111111u;
    }

    /**
     * Set MRBR1's R_BUF_SIZE field.
     *
     * Receive buffer size (in bytes)
     */
    inline void set_MRBR1_R_BUF_SIZE(uint8_t value) volatile
    {
        uint32_t curr = MRBR1;
    ...
    /**
     * Get RDSR2's R_DES_START field.
     *
     * Pointer to the beginning of receive buffer descriptor queue 2.
     */
    inline uint32_t get_RDSR2_R_DES_START() volatile
    {
        return (RDSR2 >> 3u) & 0b11111111111111111111111111111u;
    }

    /**
     * Set RDSR2's R_DES_START field.
     *
     * Pointer to the beginning of receive buffer descriptor queue 2.
     */
    inline void set_RDSR2_R_DES_START(uint32_t value) volatile
    {
        uint32_t curr = RDSR2;
    ...
    /**
     * Get TDSR2's X_DES_START field.
     *
     * Pointer to the beginning of transmit buffer descriptor queue 2.
     */
    inline uint32_t get_TDSR2_X_DES_START() volatile
    {
        return (TDSR2 >> 3u) & 0b11111111111111111111111111111u;
    }

    /**
     * Set TDSR2's X_DES_START field.
     *
     * Pointer to the beginning of transmit buffer descriptor queue 2.
     */
    inline void set_TDSR2_X_DES_START(uint32_t value) volatile
    {
        uint32_t curr = TDSR2;
    ...
    /**
     * Get MRBR2's R_BUF_SIZE field.
     *
     * Receive buffer size (in bytes)
     */
    inline uint8_t get_MRBR2_R_BUF_SIZE() volatile
    {
        return (MRBR2 >> 4u) & 0b1111111u;
    }

    /**
     * Set MRBR2's R_BUF_SIZE field.
     *
     * Receive buffer size (in bytes)
     */
    inline void set_MRBR2_R_BUF_SIZE(uint8_t value) volatile
    {
        uint32_t curr = MRBR2;
     ...
     * Receive buffer size in bytes
     */
    inline uint8_t get_MRBR_R_BUF_SIZE() volatile
    {
        return (MRBR >> 4u) & 0b1111111u;
    }
     ...
     * Receive buffer size in bytes
     */
    inline void set_MRBR_R_BUF_SIZE(uint8_t value) volatile
    {
        uint32_t curr = MRBR;
     ...
     */
    inline uint16_t get_RSFL_RX_SECTION_FULL() volatile
    {
        return (RSFL >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of Receive FIFO Section Full Threshold
     */
    inline void set_RSFL_RX_SECTION_FULL(uint16_t value) volatile
    {
        uint32_t curr = RSFL;
     ...
     */
    inline uint16_t get_RSEM_RX_SECTION_EMPTY() volatile
    {
        return (RSEM >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of The Receive FIFO Section Empty Threshold
     */
    inline void set_RSEM_RX_SECTION_EMPTY(uint16_t value) volatile
    {
        uint32_t curr = RSEM;
    ...
    inline void get_RSEM(uint8_t &STAT_SECTION_EMPTY,
                         uint16_t &RX_SECTION_EMPTY) volatile
    {
        uint32_t curr = RSEM;

        STAT_SECTION_EMPTY = (curr >> 16u) & 0b11111u;
        RX_SECTION_EMPTY = (curr >> 0u) & 0b1111111111u;
    }
                         ...
                         uint16_t RX_SECTION_EMPTY) volatile
    {
        ...
        curr &= ~(0b1111111111u << 0u);
        curr |= (RX_SECTION_EMPTY & 0b1111111111u) << 0u;
     ...
     */
    inline uint16_t get_RAEM_RX_ALMOST_EMPTY() volatile
    {
        return (RAEM >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of The Receive FIFO Almost Empty Threshold
     */
    inline void set_RAEM_RX_ALMOST_EMPTY(uint16_t value) volatile
    {
        uint32_t curr = RAEM;
     ...
     */
    inline uint16_t get_RAFL_RX_ALMOST_FULL() volatile
    {
        return (RAFL >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of The Receive FIFO Almost Full Threshold
     */
    inline void set_RAFL_RX_ALMOST_FULL(uint16_t value) volatile
    {
        uint32_t curr = RAFL;
     ...
     */
    inline uint16_t get_TSEM_TX_SECTION_EMPTY() volatile
    {
        return (TSEM >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of The Transmit FIFO Section Empty Threshold
     */
    inline void set_TSEM_TX_SECTION_EMPTY(uint16_t value) volatile
    {
        uint32_t curr = TSEM;
     ...
     */
    inline uint16_t get_TAEM_TX_ALMOST_EMPTY() volatile
    {
        return (TAEM >> 0u) & 0b1111111111u;
    }
     ...
     * Value of Transmit FIFO Almost Empty Threshold
     */
    inline void set_TAEM_TX_ALMOST_EMPTY(uint16_t value) volatile
    {
        uint32_t curr = TAEM;
     ...
     */
    inline uint16_t get_TAFL_TX_ALMOST_FULL() volatile
    {
        return (TAFL >> 0u) & 0b1111111111u;
    }
     ...
     * Value Of The Transmit FIFO Almost Full Threshold
     */
    inline void set_TAFL_TX_ALMOST_FULL(uint16_t value) volatile
    {
        uint32_t curr = TAFL;
    ...
    /**
     * Get RCMR's MATCHEN bit.
     *
     * Match Enable
     */
    inline bool get_RCMR_MATCHEN(std::size_t index) volatile
    {
        return RCMR[index] & (1u << 16u);
    }

    /**
     * Set RCMR's MATCHEN bit.
     *
     * Match Enable
     */
    inline void set_RCMR_MATCHEN() volatile
    {
        RCMR |= 1u << 16u;
    }

    /**
     * Clear RCMR's MATCHEN bit.
     *
     * Match Enable
     */
    inline void clear_RCMR_MATCHEN() volatile
    {
        RCMR &= ~(1u << 16u);
    }

    /**
     * Toggle RCMR's MATCHEN bit.
     *
     * Match Enable
     */
    inline void toggle_RCMR_MATCHEN() volatile
    {
        RCMR ^= 1u << 16u;
    }

    /**
     * Get RCMR's CMP3 field.
     *
     * Compare 3
     */
    inline uint8_t get_RCMR_CMP3(std::size_t index) volatile
    {
        return (RCMR[index] >> 12u) & 0b111u;
    }

    /**
     * Set RCMR's CMP3 field.
     *
     * Compare 3
     */
    inline void set_RCMR_CMP3(std::size_t index, uint8_t value) volatile
    {
        uint32_t curr = RCMR[index];
    ...
    /**
     * Get RCMR's CMP2 field.
     *
     * Compare 2
     */
    inline uint8_t get_RCMR_CMP2(std::size_t index) volatile
    {
        return (RCMR[index] >> 8u) & 0b111u;
    }

    /**
     * Set RCMR's CMP2 field.
     *
     * Compare 2
     */
    inline void set_RCMR_CMP2(std::size_t index, uint8_t value) volatile
    {
        uint32_t curr = RCMR[index];
    ...
    /**
     * Get RCMR's CMP1 field.
     *
     * Compare 1
     */
    inline uint8_t get_RCMR_CMP1(std::size_t index) volatile
    {
        return (RCMR[index] >> 4u) & 0b111u;
    }

    /**
     * Set RCMR's CMP1 field.
     *
     * Compare 1
     */
    inline void set_RCMR_CMP1(std::size_t index, uint8_t value) volatile
    {
        uint32_t curr = RCMR[index];
    ...
    /**
     * Get RCMR's CMP0 field.
     *
     * Compare 0
     */
    inline uint8_t get_RCMR_CMP0(std::size_t index) volatile
    {
        return (RCMR[index] >> 0u) & 0b111u;
    }

    /**
     * Set RCMR's CMP0 field.
     *
     * Compare 0
     */
    inline void set_RCMR_CMP0(std::size_t index, uint8_t value) volatile
    {
        uint32_t curr = RCMR[index];
    ...
    /**
     * Get all of RCMR's bit fields.
     *
     * (read-write) Receive Classification Match Register for Class n
     */
    inline void get_RCMR(std::size_t index, bool &MATCHEN, uint8_t &CMP3,
                         uint8_t &CMP2, uint8_t &CMP1, uint8_t &CMP0) volatile
    {
        uint32_t curr = RCMR[index];

        MATCHEN = curr & (1u << 16u);
        CMP3 = (curr >> 12u) & 0b111u;
        CMP2 = (curr >> 8u) & 0b111u;
        CMP1 = (curr >> 4u) & 0b111u;
        CMP0 = (curr >> 0u) & 0b111u;
    }
    ...
    /**
     * Set all of RCMR's bit fields.
     *
     * (read-write) Receive Classification Match Register for Class n
     */
    inline void set_RCMR(std::size_t index, bool MATCHEN, uint8_t CMP3,
                         uint8_t CMP2, uint8_t CMP1, uint8_t CMP0) volatile
    {
        uint32_t curr = RCMR[index];

        curr &= ~(0b1u << 16u);
        curr |= (MATCHEN & 0b1u) << 16u;
        curr &= ~(0b111u << 12u);
        curr |= (CMP3 & 0b111u) << 12u;
        curr &= ~(0b111u << 8u);
        curr |= (CMP2 & 0b111u) << 8u;
        curr &= ~(0b111u << 4u);
        curr |= (CMP1 & 0b111u) << 4u;
    ...
    /**
     * Get DMACFG's CALC_NOIPG bit.
     *
     * Calculate no IPG
     */
    inline bool get_DMACFG_CALC_NOIPG(std::size_t index) volatile
    {
        return DMACFG[index] & (1u << 17u);
    }

    /**
     * Set DMACFG's CALC_NOIPG bit.
     *
     * Calculate no IPG
     */
    inline void set_DMACFG_CALC_NOIPG() volatile
    {
        DMACFG |= 1u << 17u;
    }

    /**
     * Clear DMACFG's CALC_NOIPG bit.
     *
     * Calculate no IPG
     */
    inline void clear_DMACFG_CALC_NOIPG() volatile
    {
        DMACFG &= ~(1u << 17u);
    }

    /**
     * Toggle DMACFG's CALC_NOIPG bit.
     *
     * Calculate no IPG
     */
    inline void toggle_DMACFG_CALC_NOIPG() volatile
    {
        DMACFG ^= 1u << 17u;
    }

    /**
     * Get DMACFG's DMA_CLASS_EN bit.
     *
     * DMA class enable
     */
    inline bool get_DMACFG_DMA_CLASS_EN(std::size_t index) volatile
    {
        return DMACFG[index] & (1u << 16u);
    }

    /**
     * Set DMACFG's DMA_CLASS_EN bit.
     *
     * DMA class enable
     */
    inline void set_DMACFG_DMA_CLASS_EN() volatile
    {
        DMACFG |= 1u << 16u;
    }

    /**
     * Clear DMACFG's DMA_CLASS_EN bit.
     *
     * DMA class enable
     */
    inline void clear_DMACFG_DMA_CLASS_EN() volatile
    {
        DMACFG &= ~(1u << 16u);
    }

    /**
     * Toggle DMACFG's DMA_CLASS_EN bit.
     *
     * DMA class enable
     */
    inline void toggle_DMACFG_DMA_CLASS_EN() volatile
    {
        DMACFG ^= 1u << 16u;
    }

    /**
     * Get DMACFG's IDLE_SLOPE field.
     *
     * Idle slope
     */
    inline uint16_t get_DMACFG_IDLE_SLOPE(std::size_t index) volatile
    {
        return (DMACFG[index] >> 0u) & 0b1111111111111111u;
    }

    /**
     * Set DMACFG's IDLE_SLOPE field.
     *
     * Idle slope
     */
    inline void set_DMACFG_IDLE_SLOPE(std::size_t index,
                                      uint16_t value) volatile
    {
        uint32_t curr = DMACFG[index];
    ...
    /**
     * Get all of DMACFG's bit fields.
     *
     * (read-write) DMA Class Based Configuration
     */
    inline void get_DMACFG(std::size_t index, bool &CALC_NOIPG,
                           bool &DMA_CLASS_EN, uint16_t &IDLE_SLOPE) volatile
    {
        uint32_t curr = DMACFG[index];

        CALC_NOIPG = curr & (1u << 17u);
        DMA_CLASS_EN = curr & (1u << 16u);
        IDLE_SLOPE = (curr >> 0u) & 0b1111111111111111u;
    }

    /**
     * Set all of DMACFG's bit fields.
     *
     * (read-write) DMA Class Based Configuration
     */
    inline void set_DMACFG(std::size_t index, bool CALC_NOIPG,
                           bool DMA_CLASS_EN, uint16_t IDLE_SLOPE) volatile
    {
        uint32_t curr = DMACFG[index];

        curr &= ~(0b1u << 17u);
        curr |= (CALC_NOIPG & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (DMA_CLASS_EN & 0b1u) << 16u;
        curr &= ~(0b1111111111111111u << 0u);
        curr |= (IDLE_SLOPE & 0b1111111111111111u) << 0u;

        DMACFG[index] = curr;
    }

    /**
     * Get RDAR1's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline bool get_RDAR1_RDAR() volatile
    {
        return RDAR1 & (1u << 24u);
    }

    /**
     * Set RDAR1's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void set_RDAR1_RDAR() volatile
    {
        RDAR1 |= 1u << 24u;
    }

    /**
     * Clear RDAR1's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void clear_RDAR1_RDAR() volatile
    {
        RDAR1 &= ~(1u << 24u);
    }

    /**
     * Toggle RDAR1's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void toggle_RDAR1_RDAR() volatile
    {
        RDAR1 ^= 1u << 24u;
    }

    /**
     * Get TDAR1's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline bool get_TDAR1_TDAR() volatile
    {
        return TDAR1 & (1u << 24u);
    }

    /**
     * Set TDAR1's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void set_TDAR1_TDAR() volatile
    {
        TDAR1 |= 1u << 24u;
    }

    /**
     * Clear TDAR1's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void clear_TDAR1_TDAR() volatile
    {
        TDAR1 &= ~(1u << 24u);
    }

    /**
     * Toggle TDAR1's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void toggle_TDAR1_TDAR() volatile
    {
        TDAR1 ^= 1u << 24u;
    }

    /**
     * Get RDAR2's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline bool get_RDAR2_RDAR() volatile
    {
        return RDAR2 & (1u << 24u);
    }

    /**
     * Set RDAR2's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void set_RDAR2_RDAR() volatile
    {
        RDAR2 |= 1u << 24u;
    }

    /**
     * Clear RDAR2's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void clear_RDAR2_RDAR() volatile
    {
        RDAR2 &= ~(1u << 24u);
    }

    /**
     * Toggle RDAR2's RDAR bit.
     *
     * Receive Descriptor Active
     */
    inline void toggle_RDAR2_RDAR() volatile
    {
        RDAR2 ^= 1u << 24u;
    }

    /**
     * Get TDAR2's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline bool get_TDAR2_TDAR() volatile
    {
        return TDAR2 & (1u << 24u);
    }

    /**
     * Set TDAR2's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void set_TDAR2_TDAR() volatile
    {
        TDAR2 |= 1u << 24u;
    }

    /**
     * Clear TDAR2's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void clear_TDAR2_TDAR() volatile
    {
        TDAR2 &= ~(1u << 24u);
    }

    /**
     * Toggle TDAR2's TDAR bit.
     *
     * Transmit Descriptor Active
     */
    inline void toggle_TDAR2_TDAR() volatile
    {
        TDAR2 ^= 1u << 24u;
    }

    /**
     * Get QOS's RX_FLUSH2 bit.
     *
     * RX Flush Ring 2
     */
    inline bool get_QOS_RX_FLUSH2() volatile
    {
        return QOS & (1u << 5u);
    }

    /**
     * Set QOS's RX_FLUSH2 bit.
     *
     * RX Flush Ring 2
     */
    inline void set_QOS_RX_FLUSH2() volatile
    {
        QOS |= 1u << 5u;
    }

    /**
     * Clear QOS's RX_FLUSH2 bit.
     *
     * RX Flush Ring 2
     */
    inline void clear_QOS_RX_FLUSH2() volatile
    {
        QOS &= ~(1u << 5u);
    }

    /**
     * Toggle QOS's RX_FLUSH2 bit.
     *
     * RX Flush Ring 2
     */
    inline void toggle_QOS_RX_FLUSH2() volatile
    {
        QOS ^= 1u << 5u;
    }

    /**
     * Get QOS's RX_FLUSH1 bit.
     *
     * RX Flush Ring 1
     */
    inline bool get_QOS_RX_FLUSH1() volatile
    {
        return QOS & (1u << 4u);
    }

    /**
     * Set QOS's RX_FLUSH1 bit.
     *
     * RX Flush Ring 1
     */
    inline void set_QOS_RX_FLUSH1() volatile
    {
        QOS |= 1u << 4u;
    }

    /**
     * Clear QOS's RX_FLUSH1 bit.
     *
     * RX Flush Ring 1
     */
    inline void clear_QOS_RX_FLUSH1() volatile
    {
        QOS &= ~(1u << 4u);
    }

    /**
     * Toggle QOS's RX_FLUSH1 bit.
     *
     * RX Flush Ring 1
     */
    inline void toggle_QOS_RX_FLUSH1() volatile
    {
        QOS ^= 1u << 4u;
    }

    /**
     * Get QOS's RX_FLUSH0 bit.
     *
     * RX Flush Ring 0
     */
    inline bool get_QOS_RX_FLUSH0() volatile
    {
        return QOS & (1u << 3u);
    }

    /**
     * Set QOS's RX_FLUSH0 bit.
     *
     * RX Flush Ring 0
     */
    inline void set_QOS_RX_FLUSH0() volatile
    {
        QOS |= 1u << 3u;
    }

    /**
     * Clear QOS's RX_FLUSH0 bit.
     *
     * RX Flush Ring 0
     */
    inline void clear_QOS_RX_FLUSH0() volatile
    {
        QOS &= ~(1u << 3u);
    }

    /**
     * Toggle QOS's RX_FLUSH0 bit.
     *
     * RX Flush Ring 0
     */
    inline void toggle_QOS_RX_FLUSH0() volatile
    {
        QOS ^= 1u << 3u;
    }

    /**
     * Get QOS's TX_SCHEME field.
     *
     * TX scheme configuration
     */
    inline ENET_1G_QOS_TX_SCHEME get_QOS_TX_SCHEME() volatile
    {
        return ENET_1G_QOS_TX_SCHEME((QOS >> 0u) & 0b111u);
    }

    /**
     * Set QOS's TX_SCHEME field.
     *
     * TX scheme configuration
     */
    inline void set_QOS_TX_SCHEME(ENET_1G_QOS_TX_SCHEME value) volatile
    {
        uint32_t curr = QOS;
    ...
    /**
     * Get all of QOS's bit fields.
     *
     * (read-write) QOS Scheme
     */
    inline void get_QOS(bool &RX_FLUSH2, bool &RX_FLUSH1, bool &RX_FLUSH0,
                        ENET_1G_QOS_TX_SCHEME &TX_SCHEME) volatile
    {
        uint32_t curr = QOS;

        RX_FLUSH2 = curr & (1u << 5u);
        RX_FLUSH1 = curr & (1u << 4u);
        RX_FLUSH0 = curr & (1u << 3u);
        TX_SCHEME = ENET_1G_QOS_TX_SCHEME((curr >> 0u) & 0b111u);
    }

    /**
     * Set all of QOS's bit fields.
     *
     * (read-write) QOS Scheme
     */
    inline void set_QOS(bool RX_FLUSH2, bool RX_FLUSH1, bool RX_FLUSH0,
                        ENET_1G_QOS_TX_SCHEME TX_SCHEME) volatile
    {
        uint32_t curr = QOS;

        curr &= ~(0b1u << 5u);
        curr |= (RX_FLUSH2 & 0b1u) << 5u;
        curr &= ~(0b1u << 4u);
        curr |= (RX_FLUSH1 & 0b1u) << 4u;
        curr &= ~(0b1u << 3u);
        curr |= (RX_FLUSH0 & 0b1u) << 3u;
        curr &= ~(0b111u << 0u);
        curr |= (std::to_underlying(TX_SCHEME) & 0b111u) << 0u;
     ...
     * Timer Mode
     */
    inline ENET_1G_TCSR0_TMODE get_TCSR0_TMODE() volatile
    {
        return ENET_1G_TCSR0_TMODE((TCSR0 >> 2u) & 0b1111u);
    }
     ...
     * Timer Mode
     */
    inline void set_TCSR0_TMODE(ENET_1G_TCSR0_TMODE value) volatile
    {
        uint32_t curr = TCSR0;
     ...
     */
    inline void get_TCSR0(bool &TF, bool &TIE, ENET_1G_TCSR0_TMODE &TMODE,
                          bool &TDRE) volatile
    {
        uint32_t curr = TCSR0;
        ...
        TF = curr & (1u << 7u);
        TIE = curr & (1u << 6u);
        TMODE = ENET_1G_TCSR0_TMODE((curr >> 2u) & 0b1111u);
        TDRE = curr & (1u << 0u);
    }
     ...
     * (read-write) Timer Control Status Register
     */
    inline void set_TCSR0(bool TF, bool TIE, ENET_1G_TCSR0_TMODE TMODE,
                          bool TDRE) volatile
    {
        uint32_t curr = TCSR0;
     ...
     * Timer Mode
     */
    inline ENET_1G_TCSR1_TMODE get_TCSR1_TMODE() volatile
    {
        return ENET_1G_TCSR1_TMODE((TCSR1 >> 2u) & 0b1111u);
    }
     ...
     * Timer Mode
     */
    inline void set_TCSR1_TMODE(ENET_1G_TCSR1_TMODE value) volatile
    {
        uint32_t curr = TCSR1;
     ...
     * (read-write) Timer Control Status Register
     */
    inline void get_TCSR1(bool &TF, bool &TIE, ENET_1G_TCSR1_TMODE &TMODE,
                          bool &TDRE) volatile
    {
        uint32_t curr = TCSR1;
        ...
        TF = curr & (1u << 7u);
        TIE = curr & (1u << 6u);
        TMODE = ENET_1G_TCSR1_TMODE((curr >> 2u) & 0b1111u);
        TDRE = curr & (1u << 0u);
    }
     ...
     * (read-write) Timer Control Status Register
     */
    inline void set_TCSR1(bool TF, bool TIE, ENET_1G_TCSR1_TMODE TMODE,
                          bool TDRE) volatile
    {
        uint32_t curr = TCSR1;
     ...
     * Timer Mode
     */
    inline ENET_1G_TCSR2_TMODE get_TCSR2_TMODE() volatile
    {
        return ENET_1G_TCSR2_TMODE((TCSR2 >> 2u) & 0b1111u);
    }
     ...
     * Timer Mode
     */
    inline void set_TCSR2_TMODE(ENET_1G_TCSR2_TMODE value) volatile
    {
        uint32_t curr = TCSR2;
     ...
     * (read-write) Timer Control Status Register
     */
    inline void get_TCSR2(bool &TF, bool &TIE, ENET_1G_TCSR2_TMODE &TMODE,
                          bool &TDRE) volatile
    {
        uint32_t curr = TCSR2;
        ...
        TF = curr & (1u << 7u);
        TIE = curr & (1u << 6u);
        TMODE = ENET_1G_TCSR2_TMODE((curr >> 2u) & 0b1111u);
        TDRE = curr & (1u << 0u);
    }
     ...
     * (read-write) Timer Control Status Register
     */
    inline void set_TCSR2(bool TF, bool TIE, ENET_1G_TCSR2_TMODE TMODE,
                          bool TDRE) volatile
    {
        uint32_t curr = TCSR2;
     ...
     * Timer Mode
     */
    inline ENET_1G_TCSR3_TMODE get_TCSR3_TMODE() volatile
    {
        return ENET_1G_TCSR3_TMODE((TCSR3 >> 2u) & 0b1111u);
    }
     ...
     * Timer Mode
     */
    inline void set_TCSR3_TMODE(ENET_1G_TCSR3_TMODE value) volatile
    {
        uint32_t curr = TCSR3;
     ...
     * (read-write) Timer Control Status Register
     */
    inline void get_TCSR3(bool &TF, bool &TIE, ENET_1G_TCSR3_TMODE &TMODE,
                          bool &TDRE) volatile
    {
        uint32_t curr = TCSR3;
        ...
        TF = curr & (1u << 7u);
        TIE = curr & (1u << 6u);
        TMODE = ENET_1G_TCSR3_TMODE((curr >> 2u) & 0b1111u);
        TDRE = curr & (1u << 0u);
    }
     ...
     * (read-write) Timer Control Status Register
     */
    inline void set_TCSR3(bool TF, bool TIE, ENET_1G_TCSR3_TMODE TMODE,
                          bool TDRE) volatile
    {
        uint32_t curr = TCSR3;
...
static_assert(sizeof(enet_1g) == enet_1g::size);

static volatile enet_1g *const ENET_1G =
    reinterpret_cast<enet_1g *>(0x40420000);
