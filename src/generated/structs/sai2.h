...
#include "../enums/SAI2_RCR2_MSEL.h"
#include "../enums/SAI2_RCR4_FPACK.h"
#include "../enums/SAI2_RMR_RWM.h"
#include "../enums/SAI2_TCR2_MSEL.h"
#include "../enums/SAI2_TCR4_FPACK.h"
#include "../enums/SAI2_TMR_TWM.h"
#include "../enums/SAI2_VERID_FEATURE.h"
 ...
 * SAI
 */
struct [[gnu::packed]] sai2
{
    /* Constant attributes. */
    static constexpr std::size_t size = 228; /*!< sai2's size in bytes. */
    ...
    uint32_t TDR0;  /*!< (read-write) Transmit Data */
    static constexpr std::size_t reserved_padding0_length = 7;
    const uint32_t reserved_padding0[reserved_padding0_length] = {};
    uint32_t TFR0; /*!< (read-write) Transmit FIFO */
    ...
    uint32_t RDR0; /*!< (read-write) Receive Data */
    static constexpr std::size_t reserved_padding3_length = 7;
    const uint32_t reserved_padding3[reserved_padding3_length] = {};
    uint32_t RFR0; /*!< (read-write) Receive FIFO */
     ...
     */
    inline SAI2_VERID_FEATURE get_VERID_FEATURE() volatile
    {
        return SAI2_VERID_FEATURE((VERID >> 0u) & 0b1111111111111111u);
    }
    ...
    inline void get_VERID(uint8_t &MAJOR, uint8_t &MINOR,
                          SAI2_VERID_FEATURE &FEATURE) volatile
    {
        uint32_t curr = VERID;

        MAJOR = (curr >> 24u) & 0b11111111u;
        MINOR = (curr >> 16u) & 0b11111111u;
        FEATURE = SAI2_VERID_FEATURE((curr >> 0u) & 0b1111111111111111u);
    }
     ...
     * MCLK Select
     */
    inline SAI2_TCR2_MSEL get_TCR2_MSEL() volatile
    {
        return SAI2_TCR2_MSEL((TCR2 >> 26u) & 0b11u);
    }
     ...
     * MCLK Select
     */
    inline void set_TCR2_MSEL(SAI2_TCR2_MSEL value) volatile
    {
        uint32_t curr = TCR2;
    ...
    inline void get_TCR2(bool &SYNC, bool &BCS, bool &BCI,
                         SAI2_TCR2_MSEL &MSEL, bool &BCP, bool &BCD, bool &BYP,
                         uint8_t &DIV) volatile
    {
        ...
        BCS = curr & (1u << 29u);
        BCI = curr & (1u << 28u);
        MSEL = SAI2_TCR2_MSEL((curr >> 26u) & 0b11u);
        BCP = curr & (1u << 25u);
        BCD = curr & (1u << 24u);
        BYP = curr & (1u << 23u);
     ...
     * (read-write) Transmit Configuration 2
     */
    inline void set_TCR2(bool SYNC, bool BCS, bool BCI, SAI2_TCR2_MSEL MSEL,
     ...
     */
    inline bool get_TCR3_TCE() volatile
    {
        return TCR3 & (1u << 16u);
    }
     ...
     * Transmit Channel Enable
     */
    inline void set_TCR3_TCE() volatile
    {
        TCR3 |= 1u << 16u;
    }

    /**
     * Clear TCR3's TCE bit.
     *
     * Transmit Channel Enable
     */
    inline void clear_TCR3_TCE() volatile
    {
        TCR3 &= ~(1u << 16u);
    }

    /**
     * Toggle TCR3's TCE bit.
     *
     * Transmit Channel Enable
     */
    inline void toggle_TCR3_TCE() volatile
    {
        TCR3 ^= 1u << 16u;
    }
     ...
     */
    inline void get_TCR3(bool &TCE, uint8_t &WDFL) volatile
    {
        uint32_t curr = TCR3;
     ...
     * (read-write) Transmit Configuration 3
     */
    inline void set_TCR3(bool TCE, uint8_t WDFL) volatile
    {
        uint32_t curr = TCR3;
     ...
     * FIFO Packing Mode
     */
    inline SAI2_TCR4_FPACK get_TCR4_FPACK() volatile
    {
        return SAI2_TCR4_FPACK((TCR4 >> 24u) & 0b11u);
    }
     ...
     * FIFO Packing Mode
     */
    inline void set_TCR4_FPACK(SAI2_TCR4_FPACK value) volatile
    {
        uint32_t curr = TCR4;
     ...
     */
    inline void get_TCR4(bool &FCONT, SAI2_TCR4_FPACK &FPACK, uint8_t &FRSZ,
                         uint8_t &SYWD, bool &CHMOD, bool &MF, bool &FSE,
                         bool &ONDEM, bool &FSP, bool &FSD) volatile
    {
        uint32_t curr = TCR4;

        FCONT = curr & (1u << 28u);
        FPACK = SAI2_TCR4_FPACK((curr >> 24u) & 0b11u);
     ...
     * (read-write) Transmit Configuration 4
     */
    inline void set_TCR4(bool FCONT, SAI2_TCR4_FPACK FPACK, uint8_t FRSZ,
                         uint8_t SYWD, bool CHMOD, bool MF, bool FSE,
                         bool ONDEM, bool FSP, bool FSD) volatile
    {
        uint32_t curr = TCR4;
    ...
    /**
     * Get TDR0's TDR field.
     *
     * Transmit Data Register
     */
    inline uint32_t get_TDR0_TDR() volatile
    {
        return (TDR0 >> 0u) & 0b11111111111111111111111111111111u;
    }

    /**
     * Set TDR0's TDR field.
     *
     * Transmit Data Register
     */
    inline void set_TDR0_TDR(uint32_t value) volatile
    {
        uint32_t curr = TDR0;
    ...
    /**
     * Get TFR0's WFP field.
     *
     * Write FIFO Pointer
     */
    inline uint8_t get_TFR0_WFP() volatile
    {
        return (TFR0 >> 16u) & 0b111111u;
    }

    /**
     * Get TFR0's RFP field.
     *
     * Read FIFO Pointer
     */
    inline uint8_t get_TFR0_RFP() volatile
    {
        return (TFR0 >> 0u) & 0b111111u;
    }

    /**
     * Get all of TFR0's bit fields.
     *
     * (read-write) Transmit FIFO
     */
    inline void get_TFR0(uint8_t &WFP, uint8_t &RFP) volatile
    {
        uint32_t curr = TFR0;
     ...
     * Transmit Word Mask
     */
    inline SAI2_TMR_TWM get_TMR_TWM() volatile
    {
        return SAI2_TMR_TWM((TMR >> 0u) & 0b11111111111111111111111111111111u);
    }
     ...
     * Transmit Word Mask
     */
    inline void set_TMR_TWM(SAI2_TMR_TWM value) volatile
    {
        uint32_t curr = TMR;
     ...
     * MCLK Select
     */
    inline SAI2_RCR2_MSEL get_RCR2_MSEL() volatile
    {
        return SAI2_RCR2_MSEL((RCR2 >> 26u) & 0b11u);
    }
     ...
     * MCLK Select
     */
    inline void set_RCR2_MSEL(SAI2_RCR2_MSEL value) volatile
    {
        uint32_t curr = RCR2;
    ...
    inline void get_RCR2(bool &SYNC, bool &BCS, bool &BCI,
                         SAI2_RCR2_MSEL &MSEL, bool &BCP, bool &BCD, bool &BYP,
                         uint8_t &DIV) volatile
    {
        uint32_t curr = RCR2;
        ...
        BCS = curr & (1u << 29u);
        BCI = curr & (1u << 28u);
        MSEL = SAI2_RCR2_MSEL((curr >> 26u) & 0b11u);
        BCP = curr & (1u << 25u);
        BCD = curr & (1u << 24u);
        BYP = curr & (1u << 23u);
        DIV = (curr >> 0u) & 0b11111111u;
     ...
     * (read-write) Receive Configuration 2
     */
    inline void set_RCR2(bool SYNC, bool BCS, bool BCI, SAI2_RCR2_MSEL MSEL,
                         bool BCP, bool BCD, bool BYP, uint8_t DIV) volatile
    {
        uint32_t curr = RCR2;
     ...
     */
    inline bool get_RCR3_RCE() volatile
    {
        return RCR3 & (1u << 16u);
    }
     ...
     * Receive Channel Enable
     */
    inline void set_RCR3_RCE() volatile
    {
        RCR3 |= 1u << 16u;
    }

    /**
     * Clear RCR3's RCE bit.
     *
     * Receive Channel Enable
     */
    inline void clear_RCR3_RCE() volatile
    {
        RCR3 &= ~(1u << 16u);
    }

    /**
     * Toggle RCR3's RCE bit.
     *
     * Receive Channel Enable
     */
    inline void toggle_RCR3_RCE() volatile
    {
        RCR3 ^= 1u << 16u;
    }
     ...
     */
    inline void get_RCR3(bool &RCE, uint8_t &WDFL) volatile
    {
        uint32_t curr = RCR3;
     ...
     * (read-write) Receive Configuration 3
     */
    inline void set_RCR3(bool RCE, uint8_t WDFL) volatile
    {
        uint32_t curr = RCR3;
     ...
     * FIFO Packing Mode
     */
    inline SAI2_RCR4_FPACK get_RCR4_FPACK() volatile
    {
        return SAI2_RCR4_FPACK((RCR4 >> 24u) & 0b11u);
    }
     ...
     * FIFO Packing Mode
     */
    inline void set_RCR4_FPACK(SAI2_RCR4_FPACK value) volatile
    {
        uint32_t curr = RCR4;
     ...
     */
    inline void get_RCR4(bool &FCONT, SAI2_RCR4_FPACK &FPACK, uint8_t &FRSZ,
                         uint8_t &SYWD, bool &MF, bool &FSE, bool &ONDEM,
                         bool &FSP, bool &FSD) volatile
    {
        uint32_t curr = RCR4;

        FCONT = curr & (1u << 28u);
        FPACK = SAI2_RCR4_FPACK((curr >> 24u) & 0b11u);
        FRSZ = (curr >> 16u) & 0b11111u;
        SYWD = (curr >> 8u) & 0b11111u;
        MF = curr & (1u << 4u);
        FSE = curr & (1u << 3u);
     ...
     * (read-write) Receive Configuration 4
     */
    inline void set_RCR4(bool FCONT, SAI2_RCR4_FPACK FPACK, uint8_t FRSZ,
                         uint8_t SYWD, bool MF, bool FSE, bool ONDEM, bool FSP,
                         bool FSD) volatile
    {
        uint32_t curr = RCR4;
    ...
    /**
     * Get RDR0's RDR field.
     *
     * Receive Data Register
     */
    inline uint32_t get_RDR0_RDR() volatile
    {
        return (RDR0 >> 0u) & 0b11111111111111111111111111111111u;
    }

    /**
     * Get RFR0's WFP field.
     *
     * Write FIFO Pointer
     */
    inline uint8_t get_RFR0_WFP() volatile
    {
        return (RFR0 >> 16u) & 0b111111u;
    }

    /**
     * Get RFR0's RFP field.
     *
     * Read FIFO Pointer
     */
    inline uint8_t get_RFR0_RFP() volatile
    {
        return (RFR0 >> 0u) & 0b111111u;
    }

    /**
     * Get all of RFR0's bit fields.
     *
     * (read-write) Receive FIFO
     */
    inline void get_RFR0(uint8_t &WFP, uint8_t &RFP) volatile
    {
        uint32_t curr = RFR0;
     ...
     * Receive Word Mask
     */
    inline SAI2_RMR_RWM get_RMR_RWM() volatile
    {
        return SAI2_RMR_RWM((RMR >> 0u) & 0b11111111111111111111111111111111u);
    }
     ...
     * Receive Word Mask
     */
    inline void set_RMR_RWM(SAI2_RMR_RWM value) volatile
    {
        uint32_t curr = RMR;
...
static_assert(sizeof(sai2) == sai2::size);

static volatile sai2 *const SAI2 = reinterpret_cast<sai2 *>(0x40408000);

static volatile sai2 *const SAI3 = reinterpret_cast<sai2 *>(0x4040C000);

static volatile sai2 *const SAI4 = reinterpret_cast<sai2 *>(0x40C40000);
